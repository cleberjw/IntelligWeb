                                ...
                                <div class="card">
                                    ...
                                    <form method="POST" action="input_cli.php" enctype="multipart/form-data"
                                        ...
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4" style="font-family: 'Bai Jamjuree'"><ion-icon size="large" name="ios-contacts"></ion-icon> CLIENTES</h3>
                                        </div>
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                      ...
                                                      <input type="text" class="form-control" name="customer['birthdate_cli']">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                      ...
                                                      <input type="text" class="form-control" name="customer['phone_cli']">
                                                    </div>
                                                    
                                                    <div class="form-group col-md-2">
                                                      <label for="campo3">Celular</label>
                                                      <input type="text" class="form-control" name="customer['mobile_cli']">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                      ...
                                                      <input type="text" class="form-control" name="customer['ie_cli']">
                                                    </div>
                                                  ...
                                                  <div class="row">
                                                    <div class="form-group col-md-3">
                                                      ...
                                                      <input type="text" class="form-control" name="customer['email_cli']">
                                                    </div>
                                                  </div>
                                        <div class="line"></div>
