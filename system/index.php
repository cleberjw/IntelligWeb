...
<?php include(HEADER_TEMPLATE); ?>
          ...
          <header class="page-header">
              <div class="container-fluid">
                  ...
                  <div class="container-fluid">
                      <h2 id='logo' style="font-family: 'Bai Jamjuree'" class="no-margin-bottom">Dashboard</h2>
                  </div>
              </div>
          </header>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Total<br>Clientes</span>
                      <div class="progress">
                        <div role="progressbar" style="width: <?php echo "45%"?>; height: 4px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                      </div>
                    </div>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title" ><span>Despesas<br>Vencidas</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 5%; height: 4px;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                      </div>
                    </div>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Despesas<br>à Vencer</span>
                      <div class="progress">
                        <div role="progressbar" style="width: <?php echo "5" ?>%; height: 4px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-orange"></div>
                      </div>
                    </div>
              ...
              <div class="row">
                ...
                <div class="statistics col-lg-3 col-12">
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="text"><strong>0</strong><br><small> ATRASADOS</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
                    <div class="text"><strong>15</strong><br><small> FINALIZADOS</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-orange"><i class="fa fa-pie-chart"></i></div>
                    <div class="text"><strong>5</strong><br><small> ANDAMENTO</small></div>
                  </div>
                </div>
                <!-- Line Chart            -->
                ...
                <div class="chart col-lg-3 col-12">
                  ...
                  <div class="bar-chart has-shadow bg-white">
                    <div class="title"><strong class="text-violet">95%</strong><br><small>Execução no prazo</small></div>
                    <canvas id="barChartHome"></canvas>
                  </div>
                  <!-- Numbers-->
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-green"><i class="fa fa-line-chart"></i></div>
                    <div class="text"><strong>99.9%</strong><br><small>ïndice de Sucesso</small></div>
                  </div>
                </div>
                <div class="statistics col-lg-3 col-12">
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-red"><i class="fa fa-tasks"></i></div>
                    <div class="text"><strong>0</strong><br><small> ATRASADOS E-COMMERCE</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
                    <div class="text"><strong>30</strong><br><small> FINALIZADOS E-COMMERCE</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-orange"><i class="fa fa fa-pie-chart"></i></div>
                    <div class="text"><strong>13</strong><br><small> ANDAMENTO E-COMMERCE</small></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4">Projeto 00125</h3><small>Etapa 1</small>
                      </div>
                    </div>
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4">Projeto 00126</h3><small>Etapa 3</small>
                      </div>
                    </div>
                    <div class="project-date"><span class="hidden-sm-down">Today at 4:24 AM</span></div>
                  </div>
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4">Projeto 00128</h3><small>Finalizado</small>
                      </div>
                    </div>
                    <div class="project-date"><span class="hidden-sm-down">Today at 4:24 AM</span></div>
                  </div>
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4">Projeto 00129</h3><small>Etapa 2</small>
                      </div>
                    </div>
                    <div class="project-date"><span class="hidden-sm-down">Today at 4:24 AM</span></div>
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="overdue card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="number text-center">$ 1.200.000,00</div>
                      <div class="chart">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="checklist card">
                    ...
                    <div class="card-header d-flex align-items-center">           
                      <h2 class="h3">Lista de Tarefas </h2>
                    </div>
                    <div class="card-body no-padding">
              ...
              <div class="row">
                    ...
                    <div class="card-body no-padding">
                      ...
                      <div class="item d-flex justify-content-between">
                        <div class="info d-flex">
                          ...
                          <div class="title">
                            <h5>Confraternização Universal</h5>
                            <p>Terça-feira</p>
                          </div>
                        </div>
                ...
                <div class="col-lg-4">
                  <div class="recent-activities card">
                    ...
                    <div class="card-header">
                      <h3 class="h4">Agenda Empresarial</h3>
                    </div>
                    <div class="card-body no-padding">
                      <div class="item">
                        <div class="row">
